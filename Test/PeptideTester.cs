...
namespace Test
{
    ...
    class PeptideTester
    {
        ...
        {
            List<Peptide> pepsGroup1 = PeptideReader.ReadTsv(filePath, groupPath1, reqNumPepMeasurements);
            List<Peptide> pepsGroup2 = PeptideReader.ReadTsv(filePath, groupPath2, reqNumPepMeasurements);
            ...
            for (int i = 0; i < pepsGroup1.Count(); i++)
            {
                ...
                Assert.AreEqual(pepsGroup1[i].Intensities.Select(p => p.Detection), pepsGroup2[i].Intensities.Select(p => p.Detection));
                Assert.AreEqual(pepsGroup1[i].Intensities.Select(p => p.FileName), pepsGroup2[i].Intensities.Select(p => p.FileName));
        ...
        private static readonly object[] _isUniqueLists =
        {
            new object[] { new List<Peptide> {
                new Peptide("Seq1", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq2", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq3", "Seq3", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq4", "Seq4", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq5", "Seq5", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq6", "Seq6", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0)}, 
                new List<bool> {true, true, true, true, true, true}
            },
            new object[] { new List<Peptide> {
                new Peptide("Seq1", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq1", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq1a", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq2", "Seq2", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq3", "Seq3", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq2", "Seq4", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq5", "Seq1", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0),
                new Peptide("Seq6", "Seq6", "Prot", "Gene", "Organism", new List<Intensity>() { new Intensity("file", "group", 500, DetectionMS.MS) }, new List<string>() { "group" }, 0)},
