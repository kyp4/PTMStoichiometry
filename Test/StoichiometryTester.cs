...
namespace Test
{
    ...
    class StoichiometryTester
    {
        ...
        [Test]
        [TestCase("file.txt",       "Control", 284.6, 82746.347, true, 0.003439427)]
        [TestCase("file.txt",       "Control", 2654754284.5686586, 45737.7547, true, 58042.952)]
        [TestCase("file3.txt",      "group 45", 3579.98456, 27346.3456, true, 0.1309127)]
        [TestCase("file3.txt",      "group 45", 9843.43, 273443536.3456,  true, 0.00003599804)]
        [TestCase("file3.raw",      "group-42%AA", 0, 3857.48, false, 0)]
        [TestCase("file 4",         "98%HA",     476.64, 0, false, double.PositiveInfinity)]
        [TestCase("file_46_4.raw",  "Disease 01", 0, 0, false, double.NaN)]
